...
namespace Components
{
                       ...
                       .object())
    {
        ...
        else
        {
            ...
            {
                mGraphicsCards.AddMember(MUI::TextBuilder().tagFrame(MUI::Frame::String).tagContents(graphicsCard.productName).object());
                mGraphicsCards.AddMember(MUI::TextBuilder().tagFrame(MUI::Frame::String).tagContents(graphicsCard.manufacturerName).object());
            }
        }
