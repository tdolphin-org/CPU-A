...
namespace DataInfo
{
    const std::map<AOS::Identify::IDCPU, CPUSpec> cpuMC68k2spec {
        ...
        { AOS::Identify::IDCPU::MC68040, { "Motorola", "68040", "5 V", "0.8 um", "1990", "~3.5-8 W", 1, 1, 4 * 1024, 4 * 1024, 0, 0 } },
        { AOS::Identify::IDCPU::MC68LC040, { "Motorola", "68LC040", "5 V", "0.8 um", "1990", "~3.5-8 W", 1, 1, 4 * 1024, 4 * 1024, 0, 0 } },
    ...
    const std::map<AOS::Identify::IDPPC, CPUSpec> cpuPPC2spec {
        ...
        { AOS::Identify::IDPPC::PPC603P, { "Motorola/IBM", "603p", "2.5 V", "0.35 um", "?", "~4-5 W", 1, 1, 8 * 1024, 8 * 1024, 0, 0 } },
