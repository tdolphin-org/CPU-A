...
namespace DataInfo
{
    const std::map<GfxChipID, GfxChipSpec> gfxChip2spec {
        ...
        { GfxChipID::Tseng_Labs_ET4000AX, { "Tseng Labs", "Tseng ET4000AX", "1989", "ISA 16bit", "1um", 65, "--", "32bit @ 40 MHz" } },
        { GfxChipID::Tseng_Labs_ET4000_W32,
          { "Tseng Labs", "Tseng ET4000/W32", "1989", "ISA 16bit", "1um", 65, "--", "32bit @ 50-65 MHz" } },
        ...
        { GfxChipID::NCR_77C32BLT, { "NCR Corporation", "NCR 77C32BLT", "1993", "--", "--", 0, "--", "?? @ 60 Mhz" } },
